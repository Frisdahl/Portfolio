...
const Footer: React.FC = () => {
  ...
  return (
    <footer ref={footerRef} className="dark-section relative w-full bg-[#1c1d1e] text-white pt-24 overflow-hidden">
      ...
      {/* Footer Content */}
      <div className="relative z-[10] w-full px-8 md:px-12 lg:px-24 flex flex-col md:flex-row justify-between items-start gap-12 pb-12">
      ...
      <div className="relative z-[10] w-full">
        <div className="w-full px-8 md:px-12 lg:px-24 mb-10">
